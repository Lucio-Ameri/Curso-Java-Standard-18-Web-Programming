...
public class EjercicioPropuesto{
    ...
    private static void cargarDatosAutomaticos(List<Persona> personas) throws DocumentoInvalidoException{
    ...
    private static void ejecutarABM(List<Persona> personas){
        for(Persona persona : personas){
            persona.guardar();
            System.out.println();
    ...
    private static void cargarAlumnos(Scanner teclado, List<Persona> personas){
        String continuar;
    ...
    private static void cargarProfesores(Scanner teclado, List<Persona> personas){
        String continuar;
