    ...
    public static void main(String[] args){
        ...
        try{
            ...
            try(Connection conexion = DriverManager.getConnection(URL_BASE, USUARIO, PASSWORD);
                ...
                statement.executeUpdate("INSERT INTO usuarios (usuario, clave) VALUES " + "('user1@educacionit.com', 'user1.1234'), " + "('user2@educacionit.com', 'user2.1235'), " + "('user3@educacionit.com', 'user3.1236') " + "ON DUPLICATE KEY UPDATE clave = VALUES(clave)");
